...
goog.provide('shaka.xoffline.XDownloadManager');
 ...
 */
shaka.xoffline.XDownloadManager = function(
    storageEngine, netEngine, retryParams, config) {
  /**
   * @private {!Object.<
   *     string, !Array.<shaka.xoffline.XDownloadManager.Segment>>}
   */
  this.segments_ = {};
 ...
 */
shaka.xoffline.XDownloadManager.Segment;


/** @override */
shaka.xoffline.XDownloadManager.prototype.destroy = function() {
 ...
 */
shaka.xoffline.XDownloadManager.prototype.addSegment = function(
 ...
 * @return {!Promise}
 */
shaka.xoffline.XDownloadManager.prototype.downloadAndStore =
    function(manifest) {
...
/**
 * Stores the given manifest object and downloads all the segments
 * stores them in the database.
 *
 * @param {shakaExtern.ManifestDB} manifest
 * @return {!Promise}
 */
shaka.xoffline.XDownloadManager.prototype.storeAndDownload =
    function(manifest) {
  var MapUtils = shaka.util.MapUtils;
  // Calculate progress estimates.
  this.givenBytesTotal_ = 0;
  ...
  this.promise_ = this.storageEngine_.insert(
      'manifest', manifest).then(function() {
...
/**
 * Stores the manifest to the database.
 *
 * @param      {shakaExtern.ManifestDB}  manifest  The manifest
 * @return     {!Promise}
 */
shaka.xoffline.XDownloadManager.prototype.store = function(manifest) {
  return this.storageEngine_.insert('manifest', manifest);
};


/**
 * Downloads segments using manifest.
 *
 * @param      {shakaExtern.ManifestDB}  manifest  The manifest
 * @return     {!Promise}
 */
shaka.xoffline.XDownloadManager.prototype.download = function(manifest) {
  var MapUtils = shaka.util.MapUtils;
  // Calculate progress estimates.
  this.givenBytesTotal_ = 0;
  this.givenBytesDownloaded_ = 0;
...
/**
 * Cleans up stored segments.
 */
shaka.xoffline.XDownloadManager.prototype.cleanupStoredSegments = function() {
  this.storedSegments_ = [];
};
 ...
 *
 * @param {shaka.xoffline.XDownloadManager.Segment} segment
 * @return {!Promise}
 * @private
 */
shaka.xoffline.XDownloadManager.prototype.downloadSegment_ = function(segment) {
 ...
 * @private
 */
shaka.xoffline.XDownloadManager.prototype.updateProgress_ = function() {
